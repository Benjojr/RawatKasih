...
<head>
    ...
    <title>@yield('title', 'RawatKasih')</title>
    ...
    <aside class="w-60 bg-white shadow-sm flex flex-col justify-between py-6 px-4 fixed h-full">
        <div>
            ...
            <nav class="flex flex-col gap-1">
                <a href="{{ route('dashboard.pramurukti') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                    {{ request()->routeIs('dashboard.pramurukti') ? 'bg-green-50 text-green-600' : 'text-gray-500 hover:bg-gray-100' }}">
                ...
                <a href="{{ route('pramurukti.pasien.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                    {{ request()->routeIs('pramurukti.pasien.*') ? 'bg-green-50 text-green-600' : 'text-gray-500 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('pramurukti.tugas.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                    {{ request()->routeIs('pramurukti.tugas.*') ? 'bg-green-50 text-green-600' : 'text-gray-500 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
