...
<head>
    ...
    <title>@yield('title', 'RawatKasih - Keluarga')</title>
        ...
        <div>
            <div class="flex items-center gap-3 mb-10">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Portal Keluarga</p>
                </div>
            </div>
            ...
            <nav class="flex flex-col gap-1">
                <a href="{{ route('dashboard.keluarga') }}"
                    ...
                    {{ request()->routeIs('dashboard.keluarga') ? 'bg-green-50 text-green-600' : 'text-gray-500 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                ...
                <a href="{{ route('keluarga.kesehatan.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                    {{ request()->routeIs('keluarga.kesehatan.*') ? 'bg-green-50 text-green-600' : 'text-gray-500 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('keluarga.kunjungan.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                    {{ request()->routeIs('keluarga.kunjungan.*') ? 'bg-green-50 text-green-600' : 'text-gray-500 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
